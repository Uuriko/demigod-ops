...
function normalizeUserChatText(s) {
  return String(s || '')
    ...
    // residual: hows|howz|whats|whatz + aboutyourplan (parity howboutyourplan / howsabouttheplan; cannot split)
    .replace(/\bhowsaboutyourplan\b/g, 'how about your plan')
    .replace(/\bhowzaboutyourplan\b/g, 'how about your plan')
    .replace(/\bwhatsaboutyourplan\b/g, 'what about your plan')
    .replace(/\bwhatzaboutyourplan\b/g, 'what about your plan')
    ...
    // residual: dropya|dumpya|shootya|tossya|sendya|readya|peepya|peekya the plan (parity giveya/showya)
    .replace(/\bdropya\b/g, 'drop ya')
    .replace(/\bdumpya\b/g, 'dump me') // residual: dumpya the plan (parity dumpme + dropya → isTickPlanAsk; no invent RSVPs)
    ...
    .replace(/\bsup w\/?(?=\s)/g, 'sup with') // residual: sup w the plan (parity hit me w → Owner tick plan)
