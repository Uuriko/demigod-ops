...
fs.writeFileSync('/home/potter/HEAVY-PIXEL-OVERWORLD-FEEDBACK.md', data.text);
if (data.codeBlocks.length) {
  fs.writeFileSync('/home/potter/HEAVY-PIXEL-OVERWORLD-CODE.js', data.codeBlocks.at(-1));
}
console.log('saved', data.text.length, 'chars, code:', !!data.codeBlocks.length);
