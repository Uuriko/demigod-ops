...
console.log(`waiting ${WAIT_MS / 1000}s for Heavy store pass...`);
...
fs.writeFileSync('/home/potter/HEAVY-STORE-PASS-FEEDBACK.md', data.text);
console.log('saved store pass', data.text.length, 'chars');
