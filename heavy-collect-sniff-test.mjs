...
const WAIT_MS = 90000;
console.log(`waiting ${WAIT_MS / 1000}s for Heavy sniff test...`);
...
fs.writeFileSync('/home/potter/HEAVY-SNIFF-FEEDBACK.md', data.text);
console.log('saved HEAVY-SNIFF-FEEDBACK.md', data.text.length, 'chars');
