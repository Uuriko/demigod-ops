...
fs.writeFileSync('/home/potter/HEAVY-SIMPLIFY-FEEDBACK.md', data.text);
if (data.codeBlocks.length) {
  fs.writeFileSync('/home/potter/HEAVY-SIMPLIFY-CODE.js', data.codeBlocks.join('\n\n'));
}
console.log('saved simplify feedback', data.text.length, 'chars');
