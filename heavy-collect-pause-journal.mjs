...
const WAIT_MS = 90000;
console.log(`waiting ${WAIT_MS / 1000}s for Heavy pause/journal...`);
...
fs.writeFileSync('/home/potter/HEAVY-PAUSE-JOURNAL-FEEDBACK.md', data.text);
console.log('saved pause/journal', data.text.length, 'chars');
