...
/** Live rooms. Menu, rail, and footer all render this. Forum + Chess only. Studio, How to buy, Desk, Simp, Faucet, Graph, Dancer, Bounties, Privacy, Learn, Verse stay off chrome. */
...
export const AWARD_FOOT_CSS = 'footer.dasha-foot,.dasha-foot{margin:0;padding:1.25rem 1.25rem calc(180px + env(safe-area-inset-bottom,0px));background:#070608;color:#f4eddb;font:900 1rem/1.3 Arial,Helvetica,sans-serif}footer.dasha-foot a,.dasha-foot a{display:inline-flex;align-items:center;min-height:48px;min-width:48px;padding:0 .65rem;color:#f4eddb;text-decoration:none}footer.dasha-foot a:hover,.dasha-foot a:hover{color:#dfff00}footer.dasha-foot .buy-dasha,.dasha-foot .buy-dasha,footer.dasha-foot .buy-dasha:hover,.dasha-foot .buy-dasha:hover{background:#dfff00;color:#070608;padding:0 1rem}footer.dasha-foot nav,.dasha-foot nav{display:flex;flex-wrap:wrap;gap:.15rem .25rem}';
...
export const AWARD_BTN_CSS = 'a.btn,a.pill,a.buy,a.buy-dasha,.w-button,button.btn,button.pill,button.copy,button.buy-sticky-copy,.faucet-go,.faucet-back,.forum-send,.forum-back,.lobby-send,.lobby-x-btn,.lobby-x-unlink,.dasha-menu summary{display:inline-flex;align-items:center;justify-content:center;padding:.65rem 1.1rem;font-family:"Arial Black",Helvetica,Arial,sans-serif!important;font-weight:900!important;font-size:1rem!important;min-height:48px;opacity:1}a.btn:not(.ghost),a.pill.primary,a.buy-dasha,.w-button,button.btn:not(.ghost),.faucet-go,.forum-send,.lobby-send,button.copy{background:#dfff00!important;color:#070608!important;border-color:#dfff00}a.btn.ghost,a.pill:not(.primary):not(.buy-dasha),button.btn.ghost,.faucet-back,.forum-back,.lobby-x-btn,.lobby-x-unlink,button.buy-sticky-copy{background:transparent!important;color:#f4eddb!important;border:1px solid #f4eddb!important}.dasha-menu summary{background:none!important;color:#f4eddb!important;border:0}a.btn:disabled,button.btn:disabled,.forum-send:disabled,.lobby-send:disabled,.faucet-go:disabled{opacity:.7;color:inherit}a.buy-dasha:hover,.pill.primary:hover,a.btn:not(.ghost):hover,button.btn:not(.ghost):hover,.w-button:hover{color:#070608!important}a.btn:focus-visible,button.btn:focus-visible,.dasha-menu summary:focus-visible,.faucet-go:focus-visible,.forum-send:focus-visible{outline:3px solid #dfff00;outline-offset:3px}';
