...
export const AWARD_ROOM_CSS = 'header.dasha-hero,#grwm,#dasha-tape,#stills,#simp,#chess,#faucet,#token{position:relative}header.dasha-hero::before,#grwm::before,#dasha-tape::before,#stills::before,#simp::before,#chess::before,#faucet::before,#token::before{position:absolute;left:1rem;top:1.1rem;color:#dfff00;font:700 11px/1 Arial,Helvetica,sans-serif;letter-spacing:.12em}header.dasha-hero::before{content:"[01]"}#grwm::before{content:"[02]"}#dasha-tape::before{content:"[03]"}#stills::before{content:"[04]"}#simp::before{content:"[05]"}#chess::before{content:"[06]"}#faucet::before{content:"[07]"}#token::before{content:"[08]"}#simp{min-height:100svh;box-sizing:border-box;padding:4.5rem 1.25rem 8rem}#grwm,#dasha-tape,#stills,#chess,#faucet,#token{box-sizing:border-box;padding:3.5rem 1.25rem 8rem}#grwm,#stills,#simp,#chess,#faucet,#token{opacity:0;transform:translateY(16px);transition:opacity .4s ease,transform .4s ease}#grwm.is-in,#stills.is-in,#simp.is-in,#chess.is-in,#faucet.is-in,#token.is-in{opacity:1;transform:none}#simp,#simp.is-in{opacity:1;transform:none}@media(prefers-reduced-motion:reduce){#grwm,#stills,#simp,#chess,#faucet,#token{opacity:1;transform:none;transition:none}}';
