...
console.log(`waiting ${WAIT_MS / 1000}s for Heavy spacious-store reply...`);
...
fs.writeFileSync('/home/potter/HEAVY-SPACIOUS-STORE-FEEDBACK.md', data.text);
console.log('saved HEAVY-SPACIOUS-STORE-FEEDBACK.md', data.text.length, 'chars');
