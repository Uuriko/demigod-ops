...
export const TOOLS = [
  ...
  { id: 'structured-hiring', name: 'Structured hiring desk', group: 'session', cmd: 'node demigod-structured-hiring.mjs status', purpose: 'Compose role-packet + pilot-batch + rediscover (Ashby/Underdog/Gem)', out: '/tmp/dg-busy/structured-hiring-status.json', hot: true, safe: true },
  ...
  { id: 'recruitai-desk', name: 'RecruitAI desk (lalalune v0.1.1)', group: 'session', cmd: 'node demigod-recruitai-desk.mjs status', purpose: 'Upstream pin + export/partner status + handoff pack for desktop GTM desk (no Demigod send)', out: '/tmp/dg-busy/recruitai-desk-status.json', hot: true, safe: true },
  { id: 'recruitai-pack', name: 'RecruitAI handoff pack', group: 'session', cmd: 'node demigod-recruitai-desk.mjs pack', purpose: 'Copy committed export + seed pack into /tmp/dg-busy/recruitai-handoff', out: '/tmp/dg-busy/recruitai-handoff/', safe: true },
  { id: 'recruitai-refresh', name: 'RecruitAI refresh desk', group: 'session', cmd: 'node demigod-recruitai-desk.mjs refresh', purpose: 'Export + partner preview + pack (local only; no Gmail/outbound)', out: '/tmp/dg-busy/recruitai-handoff/', safe: true },
  { id: 'recruitai-seed-pack', name: 'RecruitAI seed pack', group: 'session', cmd: 'node demigod-recruitai-seed-pack.mjs', purpose: 'Export/3 → CompanySeed JSONL + private exact account-change feed (no score/contacts/send)', out: '/tmp/dg-busy/recruitai-handoff/seed-pack.json', safe: true },
