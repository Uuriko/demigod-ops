...
export const TOOLS = [
  ...
  { id: 'review', name: 'Code review v2.2', group: 'session', cmd: 'bin/dg-review', purpose: 'Diff-aware rules, tier-A fix, SARIF, gates; --bug/--fix/--rescan', out: '/tmp/dg-busy/review-latest.json', hot: true },
  ...
  { id: 'review-fix', name: 'Review autofix dry', group: 'gates', cmd: 'bin/dg-review --fix --dry-run', purpose: 'Tier-A whitespace/newline/BOM preview', out: '/tmp/dg-busy/review-latest.json' },
  ...
  { id: 'ship-help', name: 'Ship help', group: 'ship', cmd: 'bin/dg ship help', purpose: 'alias → bin/dg ship help', alias: 'ship' },
