...
export const TOOLS = [
  ...
  { id: 'funnel-loop', name: 'Funnel loop status', group: 'session', cmd: 'node demigod-funnel-loop.mjs status', purpose: 'Continuous local funnel+events hygiene loop status (dogfood label funnel-loop); stop via funnel-loop stop', out: '/tmp/dg-busy/funnel-loop/state.json', hot: true },
