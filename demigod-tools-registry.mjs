...
export const TOOLS = [
  ...
  { id: 'funnel-collision-plan', name: 'Funnel duplicate cleanup plan', group: 'session', cmd: 'node demigod-funnel.mjs collision-plan', purpose: 'Write a review-only duplicate partner URL merge proposal; never changes leads', out: '/tmp/dg-busy/funnel/' },
  ...
  { id: 'events-online', name: 'Events online status', group: 'session', cmd: 'node demigod-events-online.mjs status', purpose: 'Read-only Events app, tunnel, config, and store health', hot: true },
