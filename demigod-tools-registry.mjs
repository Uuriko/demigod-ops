...
export const TOOLS = [
  ...
  { id: 'auto-propose', name: 'Auto-propose pairs', group: 'session', cmd: 'bin/dg-matches auto', purpose: 'Score inbox×roles → DEMIGOD-PAIRS proposed', out: '/tmp/dg-busy/auto-propose-latest.json', hot: true },
