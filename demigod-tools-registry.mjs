...
export const TOOLS = [
  ...
  { id: 'review', name: 'Code review v2.1', group: 'session', cmd: 'bin/dg-review', purpose: 'Diff-aware rules, tier-A fix, SARIF, gates; --bug/--fix/--rescan', out: '/tmp/dg-busy/review-latest.json', hot: true },
