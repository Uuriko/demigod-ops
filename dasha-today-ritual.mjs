...
/** Fragment string for /studio#… (no leading #). opts.src e.g. 'home' for campaign attribution. */
export function ritualStudioHash(ritual = todaysRitual(), opts = {}) {
...
export function ritualStudioPath(ritual = todaysRitual(), opts = {}) {
  return `/studio#${ritualStudioHash(ritual, opts)}`;
}

/** Minified browser IIFE for homepage — keep in sync via tests. Tags src=home. */
