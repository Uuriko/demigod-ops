...
const WAIT_MS = 90000;
console.log(`waiting ${WAIT_MS / 1000}s for Heavy store layout...`);
...
fs.writeFileSync('/home/potter/HEAVY-STORE-LAYOUT-FEEDBACK.md', data.text);
console.log('saved layout feedback', data.text.length, 'chars');
