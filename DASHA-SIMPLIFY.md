...
| Route | Job | Notes |
|-------|-----|--------|
| `/` | Seeds + mint + buy + public lines + `@dash_eats` | `/how-to-buy` is live and linked once from the footer; no duplicate primary CTA. |
...
- Gallery / social feed / accounts / leaderboards  
...
### How-to-buy rule
`dasha-how-to-buy.html` is live. Home links it once from the footer so every sitemap route is navigable; Desk keeps its focused route set.
