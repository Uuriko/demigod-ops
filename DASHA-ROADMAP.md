...
Linking earns a fixed 10-point eligibility credit; reviewed creative work is 25 points each capped at 100 per rolling 28 days; reviewed community work is 10 each capped at 40; and OSS points accept only `dasha-simp-oss/v0` tiers capped at 300. Followers, verification, likes, reposts, replies, chat volume, referrals, purchases, balances, bag size and payments score zero. Holder proof signs a short-lived message, checks the associated mint, stores only a 28-day badge expiry, publishes no wallet or balance, sends no transaction and scores zero. Season snapshots are immutable operator-created views, not promises of rewards.

Live verification on 2026-08-08 established homepage/client parity, Worker asset hash `3aee7bc0e1d1476b`, public seasons and claims routes, authenticated review rejection, anonymous holder rejection and hostile-origin rejection. Real participation and demand remain unproven.
