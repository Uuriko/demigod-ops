...
const WAIT_MS = 90000;
console.log(`waiting ${WAIT_MS / 1000}s for Heavy rhythm polish...`);
...
const data = await page.evaluate(() => {
  ...
  return { text: msgs.length ? msgs[msgs.length - 1] : document.body.innerText.slice(-10000) };
});

fs.writeFileSync('/home/potter/HEAVY-RHYTHM-POLISH-FEEDBACK.md', `# SuperGrok Heavy — Rhythm Polish\n\n${data.text}\n`);
