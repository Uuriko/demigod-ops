...
assert.deepEqual(executionViolations('<script src="https://plugin.jup.ag/plugin-v1.js" data-preload defer></script>'), []);
assert.deepEqual(executionViolations('<script src="https://plugin.jup.ag/evil.js"></script>'), ['https://plugin.jup.ag/evil.js']);
