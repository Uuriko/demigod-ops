 ...
 */
window.dgFootVersion = 'v208'; console.log('[demigod] foot v208-core loaded');
(function(){
...
function faqBlock(){/* v208: homepage FAQ removed for clarity */ var el=q('#dg-faq'); if(el)el.remove(); var ld=q('#dg-faq-jsonld'); if(ld)ld.remove(); }
...
function proofStrip(){/* v208: proof essay removed */ var el=q('#dg-proof-strip'); if(el)el.remove(); }
function contactStrip(){/* v208: no hero essay — CTAs only */ var el=q('#dg-contact-strip'); if(el)el.remove(); }
...
window.__dgFootVer='208';console.log('Demigod v208');
