...
const WAIT_MS = 90000;
console.log(`waiting ${WAIT_MS / 1000}s for Heavy interact...`);
...
fs.writeFileSync('/home/potter/HEAVY-INTERACT-FEEDBACK.md', data.text);
if (data.codeBlocks.length) {
  fs.writeFileSync('/home/potter/HEAVY-INTERACT-CODE.js', data.codeBlocks.join('\n\n'));
}
console.log('saved interact feedback', data.text.length, 'chars');
