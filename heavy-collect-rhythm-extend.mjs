...
console.log(`waiting ${WAIT_MS / 1000}s for Heavy rhythm extend reply...`);
...
const data = await page.evaluate(() => {
  ...
  return { text: msgs.length ? msgs[msgs.length - 1] : document.body.innerText.slice(-14000) };
});

fs.writeFileSync('/home/potter/HEAVY-RHYTHM-EXTEND-FEEDBACK.md', `# SuperGrok Heavy — Rhythm Extend & Hit Feedback\n\n${data.text}\n`);
