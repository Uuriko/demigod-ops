...
for(const text of ['IT’S TIME','$DASHA.','Make it. Save it. Pass it on.','MAKE SOMETHING','HOW U CRYING','IT’S AN OLD COIN','CMON','HIGH RISK','NO ENDORSEMENT IMPLIED'])assert(svg.includes(text),`social card missing ${text}`);
