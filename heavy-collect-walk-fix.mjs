...
const WAIT_MS = 90000;
console.log(`waiting ${WAIT_MS / 1000}s for Heavy walk fix...`);
...
fs.writeFileSync('/home/potter/HEAVY-WALK-FIX-FEEDBACK.md', data.text);
console.log('saved walk fix', data.text.length, 'chars');
