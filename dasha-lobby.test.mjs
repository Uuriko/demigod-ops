...
assert.match(page, /<b>\[04\]<\/b> Bounties/, 'lobby rail ends at Bounties');
...

{
  ...
  assert.doesNotMatch(verseHtml.match(/<nav aria-label="Dasha">[\s\S]*?<\/nav>/)?.[0] || '', /\/bounties/, 'verse hamburger stays bounded');
