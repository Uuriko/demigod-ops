...
assert.match(chessPage.match(/<nav aria-label="Dasha">[\s\S]*?<\/nav>/)?.[0] || '', /href="\/chess">Chess</, 'chess hamburger must include Chess');
...
assert.match(page, /<b>\[04\]<\/b> Chess/, 'lobby rail includes Chess');
