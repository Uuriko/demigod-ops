...
console.log(`waiting ${WAIT_MS / 1000}s for Heavy ship status reply...`);
...
fs.writeFileSync('/home/potter/HEAVY-SHIP-STATUS-FEEDBACK.md', data.text);
if (data.codeBlocks.length) {
  fs.writeFileSync('/home/potter/HEAVY-SHIP-STATUS-CODE.js', data.codeBlocks.join('\n\n'));
}
console.log('saved ship status feedback', data.text.length, 'chars');
