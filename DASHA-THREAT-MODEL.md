...
| **T4 — Simp Points manipulation** | Fixed event lanes, caps, reviewed GitHub evidence, holder balances score zero | Schema rejects unknown/public-evidence fields; scorer fixtures cover abuse | `npm run dasha:test:simp` |
