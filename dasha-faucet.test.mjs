...
assert.match(clientSrc, /background:#dfff00;color:#070608/, 'faucet send is acid fill + ink type');
assert.match(clientSrc, /\.faucet-back\{background:transparent;color:#f4eddb;border-color:#f4eddb\}/, 'faucet back is paper on ink');
assert.match(clientSrc, /\.faucet-go:disabled\{opacity:\.7/, 'faucet disabled type stays readable');
...
assert.doesNotMatch(pageHtml, /href="\/verse">Verse</);
